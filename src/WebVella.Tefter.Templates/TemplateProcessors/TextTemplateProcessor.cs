...
public class TextTemplateProcessor : ITemplateProcessor
{
	public Guid Id => TemplatesConstants.TEXT_CONTENT_PROCESSOR_ID;
	...
	public TemplateResultType ResultType => TemplateResultType.TextContent;
