...
public partial class AssetsFolderPanelLinkModal : TfFormBaseComponent,
    IDialogContentComponent<AssetsFolderPanelLinkModalContext>
{
    ...
    private async Task _save()
    {
        ...
        try
        {
            ...
            {
                result = AssetsService.UpdateLinkAsset(Content.Id, _form.Label, _form.Url, _form.IconUrl,
                    Content.UserId);
            }
