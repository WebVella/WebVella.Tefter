...
[TfColumn(
	Id: Constants.TF_COLUMN_NUMBER_ID,
	Name: Constants.TF_COLUMN_NUMBER_NAME,
	Description: Constants.TF_COLUMN_NUMBER_DESCRIPTION)]
[TfColumnIcon(Constants.TF_COLUMN_NUMBER_ICON)]
public class TfNumberColumn : ITfColumn
{
		...
		Data = new TfColumnData
		{
			...
			DatabaseRequirements = new List<TfColumnColumnDatabaseRequirement>
			{
				new TfColumnColumnDatabaseRequirement
				{
					...
					SupportedDatabaseColumnTypes = new List<DatabaseColumnType> { DatabaseColumnType.Number }
				}
			},
		};
