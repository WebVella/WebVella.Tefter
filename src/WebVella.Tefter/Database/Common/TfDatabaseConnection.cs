...
public class TfDatabaseConnection : IDisposable
{
    ...
    private TfDatabaseContext CurrentContext;

    internal TfDatabaseConnection(NpgsqlTransaction transaction, TfDatabaseContext suppliedContext)
    {
    ...
    internal TfDatabaseConnection(string connectionString, TfDatabaseContext suppliedContext)
    {
        CurrentContext = suppliedContext;
        transaction = null;
