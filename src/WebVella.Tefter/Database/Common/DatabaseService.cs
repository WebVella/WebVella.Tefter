...
public interface IDatabaseService
{
    ...
    DatabaseTransactionScope CreateTransactionScope(string lockKey = null);
...
public class DatabaseService : IDatabaseService
{
    ...
    public DatabaseService(IDbConfigurationService configuration, ITransactionRollbackNotifyService tranRNS)
    {
        _tranRNS = tranRNS;
    ...
    {
        return DatabaseContext.CreateContext(Configuration);
    }

    public DatabaseConnection CreateConnection()
    {
        if (DatabaseContext.Current != null)
            return DatabaseContext.Current.CreateConnection();
        else
            return DatabaseContext.CreateContext(Configuration).CreateConnection();
    }

    public DatabaseTransactionScope CreateTransactionScope(string lockKey = null)
    {
        return new DatabaseTransactionScope(Configuration, _tranRNS, lockKey);
    }
