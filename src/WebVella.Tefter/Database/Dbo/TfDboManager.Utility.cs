...
internal partial class TfDboManager
{
    ...
    protected static List<T> ConvertDataTableToModelList<T>(DataTable dt, TfDboModelMeta meta) where T : class, new()
    {
    ...
    protected static T ConvertDataTableToModel<T>(DataTable dt, TfDboModelMeta meta) where T : class, new()
    {
        if (dt.Rows.Count > 1)
    ...
    protected static T ConvertDataRowToModel<T>(DataRow dr, TfDboModelMeta meta) where T : class, new()
    {
    ...
    protected static TfDboModelMeta GetModelMeta<T>()
    {
    ...
    protected static string GenerateOrderSql(TfDboModelMeta meta, TfOrderSettings settings)
    {
...
//    }
	...
	protected static (string, string) GeneratePropertyWhereSql(TfDboModelMeta meta, string propertyName)
    {
