...
internal partial class DboManager : IDboManager
{
	...
	public List<T> GetList<T>(int? page = null, int? pageSize = null, OrderSettings order = null, string searchQuery = null) where T : class, new()
	{
	...
	/// </summary>
	public List<T> GetList<T>(string whereSql, OrderSettings order = null, params NpgsqlParameter[] parameters) where T : class, new()
	{
		string cacheKey = null;
		var meta = GetModelMeta<T>();
