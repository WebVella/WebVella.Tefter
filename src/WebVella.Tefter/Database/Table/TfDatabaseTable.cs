...
public record TfDatabaseTable : TfDatabaseObject
{
    #region <=== Meta ===>
    
    private TfDatabaseTableMeta _meta = new();
    ...
    public TfDatabaseColumnCollection Columns { get; init; } = new();
    public TfDatabaseConstraintCollection Constraints { get; init; } = new();
    public TfDatabaseIndexCollection Indexes { get; init; } = new();
