...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.SelectDisplayColumnComponent.TfSelectDisplayColumnComponent", "WebVella.Tefter")]
public partial class TfSelectDisplayColumnComponent : TucBaseViewColumn<TfSelectDisplayColumnComponentOptions>
{
	...
	public TfSelectDisplayColumnComponent(TfSpaceViewColumnScreenRegion context)
	{
		Context = context;
	}
	#endregion
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid("dd1cf064-9167-4432-b603-128b931ca89d");
	public override string Name { get; init;} = "Select Display";
