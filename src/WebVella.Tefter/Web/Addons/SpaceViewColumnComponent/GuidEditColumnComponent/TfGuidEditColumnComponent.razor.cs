...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.GuidEditColumnComponent.TfGuidEditColumnComponent", "WebVella.Tefter")]
public partial class TfGuidEditColumnComponent : TucBaseViewColumn<TfGuidEditColumnComponentOptions>
{
	...
	public override string Name { get; init;} = "GUID Edit";
