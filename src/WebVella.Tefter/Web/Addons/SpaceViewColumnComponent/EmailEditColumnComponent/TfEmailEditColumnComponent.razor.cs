...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.EmailEditColumnComponent.TfEmailEditColumnComponent", "WebVella.Tefter")]
public partial class TfEmailEditColumnComponent : TucBaseViewColumn<TfEmailEditColumnComponentOptions>
{
	#region << Constructor >>
	/// <summary>
	...
	public TfEmailEditColumnComponent(TfSpaceViewColumnScreenRegionContext context)
	{
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid("0d059c8e-5701-466d-baed-fb1a19c58808");
	public override string Name { get; init;} = "Email Edit";
