...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.SelectEditColumnComponent.TfSelectEditColumnComponent", "WebVella.Tefter")]
public partial class TfSelectEditColumnComponent : TucBaseViewColumn<TfSelectEditColumnComponentOptions>
{
	...
	public override string Name { get; init;} = "Select Edit";
