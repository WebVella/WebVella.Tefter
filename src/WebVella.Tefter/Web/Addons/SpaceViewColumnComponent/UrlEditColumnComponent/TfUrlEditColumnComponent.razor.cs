...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.UrlEditColumnComponent.TfUrlEditColumnComponent", "WebVella.Tefter")]
public partial class TfUrlEditColumnComponent : TucBaseViewColumn<TfUrlEditColumnComponentOptions>
{
	...
	public TfUrlEditColumnComponent(TfSpaceViewColumnScreenRegion context)
	{
		Context = context;
	}
	#endregion
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid("eb8a7baa-da5d-44c4-b428-1ac3a7bfa00d");
	public override string Name { get; init;} = "URL Edit";
