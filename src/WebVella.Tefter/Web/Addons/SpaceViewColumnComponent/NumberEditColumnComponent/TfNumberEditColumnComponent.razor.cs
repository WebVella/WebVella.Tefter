...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.NumberEditColumnComponent.TfNumberEditColumnComponent", "WebVella.Tefter")]
public partial class TfNumberEditColumnComponent : TucBaseViewColumn<TfNumberEditColumnComponentOptions>
{
	#region << Constructor >>
	/// <summary>
	...
	public TfNumberEditColumnComponent(TfSpaceViewColumnScreenRegion context)
	{
		Context = context;
	}
	#endregion
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid("f4adca43-55c8-4d54-ade0-1ce31f2d1a53");
	public override string Name { get; init;} = "Number Edit";
