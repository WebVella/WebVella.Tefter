...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.DateTimeDisplayColumnComponent.TfDateTimeDisplayColumnComponent", "WebVella.Tefter")]
public partial class TfDateTimeDisplayColumnComponent : TucBaseViewColumn<TfDateTimeDisplayColumnComponentOptions>
{
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid(TfConstants.TF_COLUMN_COMPONENT_DISPLAY_DATETIME_ID);
	public override string Name { get; init;} = "DateTime Display";
