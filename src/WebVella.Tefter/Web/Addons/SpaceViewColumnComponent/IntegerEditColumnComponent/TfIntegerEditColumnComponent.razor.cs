...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.IntegerEditColumnComponent.TfIntegerEditColumnComponent", "WebVella.Tefter")]
public partial class TfIntegerEditColumnComponent : TucBaseViewColumn<TfIntegerEditColumnComponentOptions>
{
	...
	public TfIntegerEditColumnComponent(TfSpaceViewColumnScreenRegion context)
	{
		Context = context;
	}
	#endregion
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid("bebb15bd-bafc-4e81-9c10-963115b131c3");
	public override string Name { get; init;} = "Integer Edit";
