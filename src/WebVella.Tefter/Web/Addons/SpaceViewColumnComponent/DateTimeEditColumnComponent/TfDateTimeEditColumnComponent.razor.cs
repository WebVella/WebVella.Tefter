...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.DateTimeEditColumnComponent.TfDateTimeEditColumnComponent", "WebVella.Tefter")]
public partial class TfDateTimeEditColumnComponent : TucBaseViewColumn<TfDateTimeEditColumnComponentOptions>
{
	...
	public TfDateTimeEditColumnComponent(TfSpaceViewColumnScreenRegionContext context)
	{
		Context = context;
	}
	#endregion
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid("0304450e-eac0-46f4-9589-17bfdb41ecc5");
	public override string Name { get; init;} = "DateTime Edit";
