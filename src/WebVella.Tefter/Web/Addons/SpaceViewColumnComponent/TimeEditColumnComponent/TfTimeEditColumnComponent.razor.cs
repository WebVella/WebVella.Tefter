...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.TimeEditColumnComponent.TfTimeEditColumnComponent", "WebVella.Tefter")]
public partial class TfTimeEditColumnComponent : TucBaseViewColumn<TfTimeEditColumnComponentOptions>
{
	...
	public override string Name { get; init;} = "Time Edit";
