...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.PhoneEditColumnComponent.TfPhoneEditColumnComponent", "WebVella.Tefter")]
public partial class TfPhoneEditColumnComponent : TucBaseViewColumn<TfPhoneEditColumnComponentOptions>
{
	...
	public override string Name { get; init;} = "Phone Edit";
