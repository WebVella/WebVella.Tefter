...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.EmailDisplayColumnComponent.TfEmailDisplayColumnComponent", "WebVella.Tefter")]
public partial class TfEmailDisplayColumnComponent : TucBaseViewColumn<TfEmailDisplayColumnComponentOptions>
{
	...
	public TfEmailDisplayColumnComponent(TfSpaceViewColumnScreenRegionContext context)
	{
		Context = context;
	}
	#endregion
	...
	public override string Name { get; init;} = "Email Display";
