...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.PhoneDisplayColumnComponent.TfPhoneDisplayColumnComponent", "WebVella.Tefter")]
public partial class TfPhoneDisplayColumnComponent : TucBaseViewColumn<TfPhoneDisplayColumnComponentOptions>
{
	...
	public TfPhoneDisplayColumnComponent(TfSpaceViewColumnScreenRegion context)
	{
		Context = context;
	}
	#endregion
	...
	#region << Properties >>
	public override Guid Id { get; init; } = new Guid("d1183066-3c70-44de-88f9-e15e61b9c0ce");
	public override string Name { get; init;} = "Phone Display";
