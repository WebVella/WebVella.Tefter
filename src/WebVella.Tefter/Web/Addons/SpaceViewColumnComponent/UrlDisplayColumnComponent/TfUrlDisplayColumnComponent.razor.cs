...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponent.UrlDisplayColumnComponent.TfUrlDisplayColumnComponent", "WebVella.Tefter")]
public partial class TfUrlDisplayColumnComponent : TucBaseViewColumn<TfUrlDisplayColumnComponentOptions>
{
	...
	public TfUrlDisplayColumnComponent(TfSpaceViewColumnScreenRegion context)
	{
		Context = context;
	}
	#endregion
	...
	public override string Name { get; init;} = "URL Display";
