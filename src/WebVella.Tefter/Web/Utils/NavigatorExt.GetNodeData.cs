...
public static partial class NavigatorExt
{
	...
	#region << Public >>
	private static TucRouteState Front_NodesProcess(this TucRouteState result)
	{
	...
	#region << Space >>
	private static TucRouteState Front_Space_NodesProcess(this TucRouteState result)
	{
	...
	private static TucRouteState Front_Space_SpaceId_NodesProcess(this TucRouteState result)
	{
	...
	#region << Space Manage >>
	private static TucRouteState Front_Space_SpaceId_Manage_NodesProcess(this TucRouteState result)
	{
	...
	private static TucRouteState Front_Space_SpaceId_Manage_Pages_NodesProcess(this TucRouteState result)
	{
	...
	private static TucRouteState Front_Space_SpaceId_Manage_Access_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId
	...
	#region << Space Page >>
	private static TucRouteState Front_Space_SpaceId_Page_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 2
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId)
	...
	private static TucRouteState Front_Space_SpaceId_Page_PageId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId
	...
	#region << Space Data >>
	private static TucRouteState Front_Space_SpaceId_SpaceData_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 2
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId)
	...
	private static TucRouteState Front_Space_SpaceId_SpaceData_SpaceDataId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId
	...
	private static TucRouteState Front_Space_SpaceId_SpaceData_SpaceDataId_Views_NodesProcess(this TucRouteState result)
	{
	...
	private static TucRouteState Front_Space_SpaceId_SpaceData_SpaceDataId_Data_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 4
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId
	...
	private static TucRouteState Front_Space_SpaceId_SpaceView_SpaceViewId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId
	...
	private static TucRouteState Front_Space_SpaceId_SpaceView_SpaceViewId_Pages_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 4
			|| result.RouteNodes[0] != RouteDataNode.Space
			|| result.RouteNodes[1] != RouteDataNode.SpaceId
	...
	#region << Pages >>
	private static TucRouteState Front_Pages_NodesProcess(this TucRouteState result)
	{
	...
	private static TucRouteState Front_Pages_PageId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 1
	...
	private static TucRouteState Admin_NodesProcess(this TucRouteState result)
	{
	...
	#region << Users >>
	private static TucRouteState Admin_Users_NodesProcess(this TucRouteState result)
	{
	...
	private static TucRouteState Admin_Users_UserId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 2
	...
	private static TucRouteState Admin_Users_UserId_Access_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Admin
			|| result.RouteNodes[1] != RouteDataNode.Users
	...
	private static TucRouteState Admin_Users_UserId_Saves_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Admin
			|| result.RouteNodes[1] != RouteDataNode.Users
	...
	#region << Roles >>
	private static TucRouteState Admin_Roles_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 1 || result.RouteNodes[0] != RouteDataNode.Admin)
			return result;
	...
	private static TucRouteState Admin_Roles_RoleId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 2
			|| result.RouteNodes[0] != RouteDataNode.Admin
	...
	private static TucRouteState Admin_DataProviders_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 1 || result.RouteNodes[0] != RouteDataNode.Admin)
			return result;
	...
	private static TucRouteState Admin_DataProviders_DataProviderId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 2
			|| result.RouteNodes[0] != RouteDataNode.Admin
	...
	private static TucRouteState Admin_DataProviders_DataProviderId_Schema_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Admin
			|| result.RouteNodes[1] != RouteDataNode.DataProviders
	...
	private static TucRouteState Admin_DataProviders_DataProviderId_Aux_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Admin
			|| result.RouteNodes[1] != RouteDataNode.DataProviders
	...
	private static TucRouteState Admin_DataProviders_DataProviderId_Synchronization_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Admin
			|| result.RouteNodes[1] != RouteDataNode.DataProviders
	...
	private static TucRouteState Admin_DataProviders_DataProviderId_Data_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Admin
			|| result.RouteNodes[1] != RouteDataNode.DataProviders
	...
	#region << Pages >>
	private static TucRouteState Admin_Pages_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 1 || result.RouteNodes[0] != RouteDataNode.Admin)
			return result;
	...
	#region << Files >>
	private static TucRouteState Admin_Files_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 1 || result.RouteNodes[0] != RouteDataNode.Admin)
			return result;
	...
	#region << Templates >>
	private static TucRouteState Admin_Templates_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 1 || result.RouteNodes[0] != RouteDataNode.Admin)
			return result;
	...
	private static TucRouteState Admin_Templates_TemplateTypeId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 2
			|| result.RouteNodes[0] != RouteDataNode.Admin
	...
	private static TucRouteState Admin_Templates_TemplateTypeId_TemplateId_NodesProcess(this TucRouteState result)
	{
		if (result.RouteNodes.Count < 3
			|| result.RouteNodes[0] != RouteDataNode.Admin
			|| result.RouteNodes[1] != RouteDataNode.Templates
