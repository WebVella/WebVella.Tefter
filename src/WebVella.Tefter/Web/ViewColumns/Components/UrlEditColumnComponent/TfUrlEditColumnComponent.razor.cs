...
public partial class TfUrlEditColumnComponent : TfBaseViewColumn<TfUrlEditColumnComponentOptions>
{
	#region << Constructor >>
	/// <summary>
	...
	public TfUrlEditColumnComponent(TfViewColumnComponentContext context)
	{
		Context = context;
	}
	#endregion
