...
public record TucDataProvider
{
	...
	public List<TucSharedColumn> SharedColumns { get; init; }
	...
	public List<TucDataProviderIdentity> Identities { get; init; }
	...
	public TucDataProvider(TfDataProvider model)
	{
		...
		Identities = model.Identities is null ? null : model.Identities.Select(x => new TucDataProviderIdentity(x)).ToList();
