...
//		string fullTypeName)
//	{
//		return _metaProvider.GetSpaceViewColumnTypeByName(fullTypeName);
//		//return _spaceViewColumnTypes.SingleOrDefault(x => x.GetType().FullName == fullTypeName);
//	}

//	private Type GetSpaceViewColumnComponentType(
//		string componentTypeName)
//	{
//		return _metaProvider.GetSpaceViewColumnComponentType(componentTypeName);
