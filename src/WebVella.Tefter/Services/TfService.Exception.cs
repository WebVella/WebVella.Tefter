...
public partial class TfService : ITfService
{
	...
	public TfValidationException LogValidationException(TfValidationException exception)
	{
		_logger.LogWarning(exception, "Message:{message} Data:{@exData}", exception.Message, exception.Data);
		return exception;
	}

	public TfServiceException LogServiceException(TfServiceException exception)
	{
		_logger.LogError(exception, "Message:{message} Data:{@exData}", exception.Message, exception.Data);
		return exception;
	}

	private TfServiceException CreateAndLogServiceException(Exception exception)
	{
