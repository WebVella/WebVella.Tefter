...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponents.TimeEditColumnComponent.TucTimeEditColumnComponent", "WebVella.Tefter")]
public partial class TucTimeEditColumnComponent : TucBaseViewColumn<TucTimeEditColumnComponentOptions>
{
	public const string ID = "4af7582b-b2c9-411d-a121-2f1ff2be6ca2";
	public const string NAME = "Time Edit";
	...
	public TucTimeEditColumnComponent()
	{
	}
	...
	public TucTimeEditColumnComponent(TfSpaceViewColumnScreenRegionContext context)
	{
	...
	public override string? GetValueAsString(IServiceProvider serviceProvider)
	{
		...
		var format = Thread.CurrentThread.CurrentCulture.DateTimeFormat.ShortTimePattern;
...
public class TucTimeEditColumnComponentOptions
{
