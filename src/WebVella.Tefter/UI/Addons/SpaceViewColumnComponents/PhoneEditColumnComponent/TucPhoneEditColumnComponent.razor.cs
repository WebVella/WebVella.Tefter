...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponents.PhoneEditColumnComponent.TucPhoneEditColumnComponent", "WebVella.Tefter")]
public partial class TucPhoneEditColumnComponent : TucBaseViewColumn<TucPhoneEditColumnComponentOptions>
{
	public const string ID = "6d778168-8dc9-4dd5-b420-55bfa0b62676";
	public const string NAME = "Phone Edit";
	...
	public TucPhoneEditColumnComponent()
	{
	}
	...
	public TucPhoneEditColumnComponent(TfSpaceViewColumnScreenRegionContext context)
	{
...
public class TucPhoneEditColumnComponentOptions
{
