...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponents.DateTimeEditColumnComponent.TucDateTimeEditColumnComponent", "WebVella.Tefter")]
public partial class TucDateTimeEditColumnComponent : TucBaseViewColumn<TucDateTimeEditColumnComponentOptions>
{
	public const string ID = "0304450e-eac0-46f4-9589-17bfdb41ecc5";
	public const string NAME = "DateTime Edit";
	...
	public TucDateTimeEditColumnComponent()
	{
	}
	...
	public TucDateTimeEditColumnComponent(TfSpaceViewColumnScreenRegionContext context)
	{
	...
	public override string? GetValueAsString(IServiceProvider serviceProvider)
	{
		...
		var format = Thread.CurrentThread.CurrentCulture.DateTimeFormat.ShortDatePattern + " " + Thread.CurrentThread.CurrentCulture.DateTimeFormat.ShortTimePattern;
		return ((DateTime)columnData!).ToString(format);
	}
	#endregion
...
public class TucDateTimeEditColumnComponentOptions
{
