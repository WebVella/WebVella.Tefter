...
/// </summary>
[LocalizationResource("WebVella.Tefter.Web.Addons.SpaceViewColumnComponents.ShortIntegerEditColumnComponent.TucShortIntegerEditColumnComponent", "WebVella.Tefter")]
public partial class TucShortIntegerEditColumnComponent : TucBaseViewColumn<TucShortIntegerEditColumnComponentOptions>
{
	public const string ID = "eb402115-c2be-408f-b4b7-7dc0fbde21c2";
	public const string NAME = "Short Integer Edit";
	...
	public TucShortIntegerEditColumnComponent()
	{
	}
	...
	public TucShortIntegerEditColumnComponent(TfSpaceViewColumnScreenRegionContext context)
	{
	...
	public override string? GetValueAsString(IServiceProvider serviceProvider)
	{
		...
		return ((short)columnData!).ToString();
	}
	#endregion
...
public class TucShortIntegerEditColumnComponentOptions
{
