...
public partial class TucSpaceDataColumnsContent : TfBaseComponent, IDisposable
{
	...
	private async Task _onAddColumn(TfDataSetColumn column)
	{
		try
		{
	...
	private async Task _onRemoveColumn(TfDataSetColumn column)
	{
		try
		{
