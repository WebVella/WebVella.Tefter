...
//					_skValue = Content.DataTable.Rows[Content.RowIndex].GetJoinKeyValue(_channel.DataIdentity);
...
//				//TODO DataIdentityValues = _skValue is not null ? new List<string> { _skValue.ToString() } : new List<string>()
//			};
